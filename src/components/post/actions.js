...
const Actions = ({likes,userLikedPhoto,docId,following,userId}) =>{
    ...
    return(
        ...
        <div className="flex justify-between p-4 pb-0">
            <div className="flex">
                <svg
                    ...
                    stroke="currentColor"
                    tabIndex={0}
                    className={`w-8 mr-4 select-none cursor-pointer focus:outline-none ${liked?'fill-red text-red-primary':'text-black-light'}`}
                    >
                    <path
                        strokeLinecap="round"
        ...
        <div className="p-4 py-0">
            <Likes numberOfLikes={numberOfLikes} likes={likes} toggleLike={toggleLiked} followingsOfCurrentUser={following}/>
        </div>
        </>
    )
}
